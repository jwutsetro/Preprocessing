...
def register_ADC_folder(path_acquisition):
    ...
    for i in range(len(uplist)-1):
        ...
        elastixImageFilter.SetParameterMap(sitk.ReadParameterFile(
                        '/Users/joriswuts/Clean_Code_versino_IMAC/01_PREPROCESSING/Euler_S2S_MSD.txt'))
...
def register_image2image(movingImage,fixedImage):
    ...
    parameterMapVector.append(sitk.ReadParameterFile(
                        '/Users/joriswuts/Clean_Code_versino_IMAC/01_PREPROCESSING/S2A_Pair_Euler_WB.txt'))
    parameterMapVector.append(sitk.ReadParameterFile(
                        '/Users/joriswuts/Clean_Code_versino_IMAC/01_PREPROCESSING/S2A_Pair_BSpline_WB.txt'))    
